  ...
  <div class="index-vue">
      ...
      <section class="sec-right">
        ...
        <div class="top-c">
          ...
          <div class="div-tags">
            <ul class="ul-c">
              <li v-for="(item, index) in tagsArry" :class="{active: isActive(item.name)}" @click="activeTag(index)" :key="index">
                <a class="li-a">
                  {{item.text}}
                </a>
  ...
  data () {
    return {
      ...
      menuItems: [
        ...
        {
          name: 'Seller', // 要跳转的路由名称 不是路径
          size: 18, // icon大小
          type: 'md-home', // icon类型
          text: '商家管理' // 文本内容
        },
        {
          name: 'Sort', // 要跳转的路由名称 不是路径
          size: 18, // icon大小
          type: 'md-home', // icon类型
          text: '分类管理' // 文本内容
        },
        ...
        {
          name: 'Shop', // 要跳转的路由名称 不是路径
          size: 18, // icon大小
          type: 'md-home', // icon类型
          text: '店铺管理' // 文本内容
        },
        {
          name: 'AddGoods', // 要跳转的路由名称 不是路径
          size: 18, // icon大小
          type: 'md-home', // icon类型
          text: '商品增加' // 文本内容
        },
        ...
        {
          name: 'AdType', // 要跳转的路由名称 不是路径
          size: 18, // icon大小
          type: 'md-home', // icon类型
          text: '广告分类管理' // 文本内容
        },
        {
          name: 'AdContent', // 要跳转的路由名称 不是路径
          size: 18, // icon大小
          type: 'md-home', // icon类型
          text: '广告管理' // 文本内容
        }
